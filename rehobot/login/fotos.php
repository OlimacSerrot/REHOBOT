				...
				<ul class="navbar-end">					 
					...
					<li class="navbar-item has-dropdown is-hoverable">
						...
						<div class="navbar-dropdown">
							...
							<a class="navbar-item" href="##">fotos</a>
						</div>
...
<div style="display: flex; justify-content: center; align-items: center;">
    <div style="margin-right: 20px;">
      <img src="images/foto.png" alt="Imagen" style="width: 620px; height: 580px;">
    </div>
    <br>
    <div>
        <iframe width="620" height="280" src="https://www.youtube.com/embed/6BCvIuSw3MI?si=aJUloiDWazSg3uXU" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
      <br>
      <iframe width="620" height="280" src="https://www.youtube.com/embed/V3GpdRRyrB0?si=h4UjroDy_YoKifha" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
    </div>
  </div>
                    ...
                    <div class="columns is-justify-content-center ">
                        <div class="column is-7-desktop is-12-tablet">
                            <div class="cta-content has-text-centered">
                                ...
                                <h2 class="text-white text-lg mb-6 mt-4">No podemos ayudar a todos, pero todos pueden ayudar a alguien.</h2>
                                <a href="donation.html" class="btn btn-main is-rounded">Hacer una donacion</a>
                            </div>
                        </div>
                    </div>
                </div>            
                ...
                <div class="columns is-justify-content-center">
                    <div class="column is-8-desktop is-10-tablet">
                        <div class="section-title has-text-centered">
                            <span class="text-color">NUESTRA GALERIA</span>
                            <h2 class="mt-4 mb-5 is-relative content-title">"La esperanza es nuestra mejor herramienta para iluminar el camino hacia la vida."
                            </h2>
                        </div>
                    </div>
                </div>
